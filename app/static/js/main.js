...
/* Collapse row in table */

document.addEventListener("DOMContentLoaded", function () {
  let b = document.getElementsByClassName("card-toggle");
  for (let a = 0; a < b.length; a++)
    b[a].addEventListener("click", (a) => {
      a.currentTarget.parentElement.parentElement.parentElement.nextSibling.classList.toggle("is-hidden");
    });
});
/* Modal from bulma site */
